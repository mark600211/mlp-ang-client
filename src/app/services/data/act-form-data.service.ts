...
import { GeneralCustomerControlService } from "../controls/consumers/general-customer-control.service";
import { CustomerControlService } from "../controls/consumers/customer-control.service";
import { EditActOptionsComponent } from "src/app/components/acts/act-form/edit-act-options/edit-act-options.component";
import { OptionsEditDataModel } from "src/app/components/acts/act-form/edit-act-options/data.model";
...
export class ActFormDataService {
  ...
  //   getItemOptions(key: string): Observable<OptionsBaseModel[]> {
  //     const options: OptionsBaseModel[] = [];
  //     this.AFCS.getItems(key).subscribe((items) => {
  //       items.forEach((item) => {
